...
const findUserReducer = (state = initialState, action: any): InitialStateTypeForFindUsers => {
  switch (action.type) {
    case FOLLOW:
...
const followUnfollowFlow = async (userId: number, apiMethod: any, action: any, dispatch: any) => {
